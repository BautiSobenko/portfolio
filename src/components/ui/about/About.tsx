...
export const About = () => {
  return (
    <section className="mb-10">
      ...
      <div className="flex flex-col h-[42rem] lg:mx-48 xl:mx-60 bg-accent-100/10 border border-bg-300 ">
        <Image
          priority
        ...
        <h2 className="mx-4 font-semibold text-xl tracking-widest">Bautista Priano Sobenko</h2>

        <hr className="mx-4 border border-bg-300"/>
 
        <div className="text-sm h-full p-4 text-center leading-7 text-balance text-text-200">
          <div className="bg-accent-100/10 flex px-2 flex-col justify-center space-y-6 h-full rounded-md">
            <p className="">
